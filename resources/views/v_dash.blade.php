                  ...
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                    ...
                    <div class="row">
                     ...
                     <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                      <div>
                          <button class="btn btn-primary btn-lg text-white mb-0 me-0" type="button" data-bs-toggle="modal" data-bs-target="#formUpload"><i class="fa-solid fa-file-import fa-xs" style="margin-right: 8px;"></i>Import Data</button>
                      </div>
                      <div>
                          <form action="{{ route('delete_all') }}" method="post">
                              @csrf
                               @method('DELETE')
                              <button class="btn btn-danger btn-lg text-white mb-0 me-0 deleteButton" type="submit"><i class="fa-solid fa-trash-can"></i>  Hapus Semua</button>
                          </form>
                      </div>
                     </div>
                     <br>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('store_file') }}" method="post" enctype="multipart/form-data" class="form-sample">
                            @csrf
                              ...
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-start align-items-center">
                                  <div>
                                    ...
                                    <p class="card-subtitle">Berikut adalah kumpulan data penjualan produk yang  belum diolah</p>
                                  </div>
                                </div>
                                  <table id="table-dataMentah" class="display wrap table-sm" style="width:100%">
                                    ...
                                    <tbody>
                                      ...
                                      <tr style="font-size: 90%;">
                                        ...
                                        <td>
                                          <a href="#" class="btn btn-success btn-lg p-2 text-white"><i class="fa-solid fa-magnifying-glass-arrow-right"></i></a>
                                        </td>
                                      </tr>
                                      @endforeach
                                    </tbody>
                    ...
                    <!-- //Row : Data Mentah -->
                     ...
                     <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                      <div>
                          ...
                          <a href="{{ route('store_export') }}" class="btn btn-dark btn-lg text-white mb-0 me-0"><i class="fa-solid fa-file-export fa-flip-horizontal"  style="margin-right: 8px;" ></i>Export excel</a>
                      </div>
                      <div>
                    ...
                    <div class="modal fade" id="formSettingsMinPembelian" tabindex="-1" aria-labelledby="formUploadLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-start align-items-center">
                                  <div>
                                    <h1 class="card-title">Data Jadi</h1>
                                    <p class="card-subtitle">Berikut adalah kumpulan data penjualan produk yang  sudah diolah dan di sorting berdasarkan tingkat pembelian terbanyak</p>
                                  </div>
                                </div>
                                  <table id="table-dataJadi" class="display wrap table-sm" style="width:100%">
                                    <thead>
                                      <tr style="font-size: 90%;">
                                        <th>#</th>
                                        <th>Nama</th>
                                    ...
                                    <tbody>
                                      ...
                                      <tr style="font-size: 90%;">
                                        ...
                                        <td>{{ $fd['quantity'] }}</td>
                                        <!-- <td>Rp.{{ number_format($d['harga'],0,',','.') }}</td> -->
                                        <td>Rp.{{ number_format($fd['total'],0,',','.') }}</td>
                                        <td>
                                          <a href="#" class="btn btn-success text-white p-2" data-bs-toggle="modal" data-bs-target="#detailPenjualan"><i class="fa-solid fa-magnifying-glass-arrow-right"></i></a>
                                        </td>
                                      </tr>
                                      @endforeach
                                    </tbody>
                    ...
                    <!-- Modal Detail Penjualan Berdasarkan Produk -->
                    <div class="modal fade" id="DetailPenjualan" tabindex="-1" aria-labelledby="formUploadLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                    ...
                    <!-- Batas Modal Detail Penjualan Berdasarkan Produk -->
