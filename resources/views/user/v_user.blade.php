                          ...
                          <table id="table-dataMentah" class="display wrap table-sm" style="width:100%">
                            ...
                            <tbody>
                              ...
                              <tr style="font-size: 90%;">
                                ...
                                <td>{{ $d->updated_at}}</td>
                                <td>
                                  <a href="{{ route('user.edit', ['id' => $d->id]) }}" class="btn btn-success btn-lg text-white p-2"><i class="fa-solid fa-edit"></i></a>
                                  <a href="#" class="btn btn-danger btn-lg text-white p-2" onclick="event.preventDefault(); if(confirm('Apakah Anda yakin ingin menghapus pengguna ini?')) { document.getElementById('delete-user-{{ $d->id }}').submit(); }">
                                    <i class="fa-solid fa-trash"></i>
                                  </a>
                                  <form id="delete-user-{{ $d->id }}" action="{{ route('user.delete', ['id' => $d->id]) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                  </form>
                                  <a href="{{ route('user.detail', ['id' => $d->id]) }}" class="btn btn-info btn-lg text-white p-2"><i class="fa-solid fa-eye"></i></a>
                                </td>
  ...
  <script type="text/javascript">
    $(function() {
      $(document).on('click', '.deleteButton', function(e) {
        ...
        Swal.fire({
          title: "Yakin Untuk  Menghapus User Tersebut?",
          icon: "warning",
